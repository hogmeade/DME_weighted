...
def load_images(directory):
    from torchvision import transforms
    transforms = transforms.Compose([transforms.Resize([224,224]),transforms.ToTensor(),transforms.Normalize(mean=[0.4340, 0.2081, 0.0643],std=[0.3067, 0.1621, 0.0794] )])
...
if __name__ == "__main__":
    ...
    args = parser.parse_args()
    execute_exp(args)
# nohup python3 dme_weighted11.py -probsThresthold 0.97 -batchNumber 1 -batch_size 16 -epochs 3000 -train_data_path '/home/huong_n_pham01/data/idrid/DME01/train' -val_data_path '/home/huong_n_pham01/data/idrid/DME01/val' -test_data_path '/home/huong_n_pham01/data/idrid/DME01/test' > outputNoweight.log &
